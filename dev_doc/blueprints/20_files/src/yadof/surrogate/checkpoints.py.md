...
## Functionalities
- Compute a semantic state signature over active strategy, method/policy, parameters,
...
- Manifests explicitly declare `surrogate_method`, `training_policy`, strategy and
  state signatures, and run/component namespaces.
