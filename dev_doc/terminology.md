...
| `Metal_recon_ant` | Current HFSS task template. The `.aedt` file lives in `project/job_template/Metal_recon_ant.aedt`, parameters are defined in `job_template/parameters_constraints.py`, and costs are dynamically calculated from S11/gain rawData. |
