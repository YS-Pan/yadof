...
3. `surrogate` predicts rawData for candidate pools.
4. `surrogate` calculates predicted costs and intervals through `job_template.api`.
5. `optimize` selects a real population and sends it to `evaluate_manager`.
