...
- Checkpoint: recoverable optimizer or surrogate state, especially per-generation surrogate checkpoints.
...
- `surrogate`: predicts rawData and converts it to cost through the same cost path.
