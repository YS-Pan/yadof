...
PIN_RETRIES = env_int("YADOT_HFSS_PIN_RETRIES", DEFAULT_PIN_RETRIES, minimum=0)
RETRY_CPUCORE = env_int("YADOT_HFSS_RETRY_CPUCORE", DEFAULT_RETRY_CPUCORE, minimum=1)
RETRY_DELAY_SEC = env_float("YADOT_HFSS_RETRY_DELAY_SEC", DEFAULT_RETRY_DELAY_SEC, minimum=0.0)
...
def main() -> None:
    ...
    runtime_info = runtime_identity(
        ...
        extra={
            ...
            "runtime_hfss_retry_cpucore": RETRY_CPUCORE,
            "runtime_hfss_pin_retries": PIN_RETRIES,
        },
    )
