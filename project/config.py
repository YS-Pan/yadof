...
ANSYS_LICENSE_SERVER = os.environ.get("YADOT_HTCONDOR_ANSYS_LICENSE_SERVER") or "1055@localhost"
HTCONDOR_ENVIRONMENT = (
    ...
    "YADOT_HFSS_JOB_CPUCORE=4;"
    "YADOT_HFSS_PARALLEL_TASKS=1;"
    "YADOT_HFSS_NON_GRAPHICAL=1;"
    "YADOT_HFSS_PIN_RETRIES=1;"
    "YADOT_HFSS_RETRY_CPUCORE=1"
)
...
HTCONDOR_ALLOWED_MACHINES = _env_csv_tuple("YADOT_HTCONDOR_ALLOWED_MACHINES",())
HTCONDOR_EXCLUDED_MACHINES = _env_csv_tuple("YADOT_HTCONDOR_EXCLUDED_MACHINES", ())
